...
PACKAGENAME = metadata.get('package_name', 'astrocut')
DESCRIPTION = metadata.get('description', 'Cutout tools for astronomical images')
AUTHOR = metadata.get('author', 'MAST Archive Developers')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: astrocut requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
