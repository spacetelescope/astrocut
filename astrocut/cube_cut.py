...
class TicaCutoutFactory():
    ...
    def __init__(self):
        ...
        self.img_kwds = {"EXPOSURE": [None, "[d] time on source"],
                         "GAINA": [None, "[electrons/count] CCD output A gain"],
                         "GAINB": [None, "[electrons/count] CCD output B gain"],
                         "GAINC": [None, "[electrons/count] CCD output C gain"],
                         "GAIND": [None, "[electrons/count] CCD output D gain"],
                         ...
                         "ACS_MODE": [None, "Attitude Control System mode"],
                         "SC_RA": [None, "Predicted RA"],
                         "SC_DEC": [None, "Predicted Dec"],
                         "SC_ROLL": [None, "Predicted roll"],
                         "SC_QUATX": [None, "Predicted S/C quaternion x"],
                         "SC_QUATY": [None, "Predicted S/C quaternion y"],
                         "SC_QUATZ": [None, "Predicted S/C quaternion z"],
                         "SC_QUATQ": [None, "Predicted S/C quaternion q"],
                         "TJD_ZERO": [None, "JD-TDB epoch for which TJD = 0"],
                         "STARTTJD": [None, "Beginning of integration in TJD (days)"],
                         ...
                         "PRIM_HUF": [None, "Huffman table for undifferenced data"],
                         "QUAL_BIT": [None, "Quality flags"],
                         "SPM": [None, "SPM number (0, 1, 2, 3)"],
                         "TIME": [None, "Beginning of integration in SCT (seconds)"],
                         "CADENCE": [None, "Cadence number since start of data collection"],
                         "CRM": [None, "Whether or not cosmic ray were mitigated"],
                         "CAMNUM": [None, "Camera Number"],
                         "CCDNUM": [None, "CCD number"],
                         "SCIPIXS": [None, ""],
                         "GAIN_A": [None, "e/ADU for CCD Sector A"],
                         "GAIN_B": [None, "e/ADU for CCD Sector B"],
                         "GAIN_C": [None, "e/ADU for CCD Sector C"],
                         "GAIN_D": [None, "e/ADU for CCD Sector D"],
                         "UNITS": [None, "Units (ADU or electrons)"],
                         "TICAVER": [None, "tica software version"],
                         "EQUINOX": [None, ""],
                         "INSTRUME": [None, ""],
                         "TELESCOP": [None, ""],
                         "FILTER": [None, ""],
                         "MJD-BEG": [None, ""],
                         "MJD-END": [None, ""],
                         "TESS_X": [None, "Spacecraft X coord, J2000 (km from barycenter)"],
                         "TESS_Y": [None, "Spacecraft Y coord, J2000 (km from barycenter)"],
                         "TESS_Z": [None, "Spacecraft Z coord, J2000 (km from barycenter)"],
                         ...
                         "RMSB": [None, "WCS fit resid bright (Tmag<10) targs [arcsec]"],
                         "RMSAP": [None, "WCS fit resid all targs [pixel]"],
                         "RMSBP": [None, "WCS fit resid bright (Tmag<10) targs [pixel]"],
                         "RMSX0": [None, "WCS fit resid extra 0 [arcsec]"],
                         "RMSX1": [None, "WCS fit resid extra 1 [arcsec]"],
                         "RMSX2": [None, "WCS fit resid extra 2 [arcsec]"],
                         "RMSX3": [None, "WCS fit resid extra 3 [arcsec]"],
                         "WCSGDF": [None, "Fraction of control point targs valid"],
                         "CTRPCOL": [None, "Subregion analysis blocks over columns"],
                         "CTRPROW": [None, "Subregion analysis blocks over rows"],
