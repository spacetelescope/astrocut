...
def creat_test_ffis(img_size, num_images, basename='make_cube-test{}.fits'):
    """
...
def test_make_cube(tmpdir):
    ...
    ffi_files = creat_test_ffis(img_sz, num_im)
    cube_file = make_cube(ffi_files, "make_cube-test-cube", verbose=False)
